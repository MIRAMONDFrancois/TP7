...
public class BankingTest {
	...
	public void successfulTransfer() throws Exception {
        ...
        public void unavailableAccountTransfer() throws Exception {
                myDAO.bankTransferTransaction(-1, 0, 1);
        }
        
        @Test (expected = SQLException.class)
        public void negativeAccountTransfer() throws Exception {
                myDAO.bankTransferTransaction(0, 1, 1000000000000000000.1f);
        }
